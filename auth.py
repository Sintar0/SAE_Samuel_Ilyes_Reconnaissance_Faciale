...
model = keras.models.load_model(r'learning_algorithm\models\model.keras')
# Fonction pour l'authentification

def authentification(model=model):
    ...
    while True:
        ...
        if ret:
            ...
            if cv2.waitKey(1) == 27 or len(authentifications) >= 60:
...
# Lancement de la fonction d'authentification

print(authentification(model=model))
